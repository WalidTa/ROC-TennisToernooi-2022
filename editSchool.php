...
$school = $obj->SelectSpecificSchool($_GET['id']);
...
if(isset($_POST['submit'])){  
 ...
 if (!$error) {
     $obj->updateSchool($_POST['naam'], $_GET['id']);
 }else{
      echo 'Fieldnames required';
 }
}
//hier boven zijn functies om een school te wijzigen
?>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <label for="naam"><h3>School naam</h3></label>
    <input type="text" name="naam" value="<?php echo $school['naam']; ?>"> <br>
